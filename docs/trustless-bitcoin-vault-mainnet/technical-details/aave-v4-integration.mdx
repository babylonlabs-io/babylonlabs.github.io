...
* [Protocol architecture](/trustless-bitcoin-vault/technical-details/protocol-architecture/): the underlying TBV protocol the integration plugs into.
* [Protocol actors](/trustless-bitcoin-vault/technical-details/protocol-actors/): the Application Vault Keeper / arbitrageur role.
* [Borrow & repay](/trustless-bitcoin-vault/use-for-lending/borrow-and-repay/) and [Liquidation risk](/trustless-bitcoin-vault/use-for-lending/liquidation-risk/): the depositor-facing flows on this integration.

...
The Trustless Bitcoin Vault (TBV) protocol has three layers: Bitcoin scripts and transactions, Ethereum contracts, and off-chain participant software. For the trust model, see [Safety & trust assumptions](/trustless-bitcoin-vault/start-here/safety-and-trust-assumptions/).
...
A new application needs its own contracts and governance registration. A vault is created for one application and cannot be moved to another application later. For the full lending stack, see [Aave v4 integration](/trustless-bitcoin-vault/technical-details/aave-v4-integration/).
...
* **Participants.** The Vault Provider, Application Vault Keepers, and Universal Challengers each run vault management software. Per-actor responsibilities are on [Protocol actors](/trustless-bitcoin-vault/technical-details/protocol-actors/).
...
* [Protocol actors](/trustless-bitcoin-vault/technical-details/protocol-actors/): who runs the off-chain roles and what each is trusted to do.
* [Aave v4 integration](/trustless-bitcoin-vault/technical-details/aave-v4-integration/): the lending application stack built on this protocol.
* [How it works](/trustless-bitcoin-vault/start-here/how-it-works/): the conceptual peg-in and peg-out walkthrough.
* [Glossary](/trustless-bitcoin-vault/reference/glossary/): definitions of the protocol-specific terms used here.

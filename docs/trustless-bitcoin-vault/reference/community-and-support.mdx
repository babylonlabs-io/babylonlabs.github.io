...
Where to ask questions, follow announcements, file issues, or reach the team about Babylon Trustless Bitcoin Vaults (TBV) Testnet.
...
* [Setup](/trustless-bitcoin-vault/testnet-info/setup/) — getting started prerequisites
* [FAQ](/trustless-bitcoin-vault/use-for-lending/faq/) — common Testnet questions and troubleshooting

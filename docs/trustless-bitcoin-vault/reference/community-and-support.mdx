...
* **Question about how something works conceptually:** check [FAQ](../use-for-lending/faq.mdx) first, then Discord
...
* [FAQ](../use-for-lending/faq.mdx) — quick answers to common questions

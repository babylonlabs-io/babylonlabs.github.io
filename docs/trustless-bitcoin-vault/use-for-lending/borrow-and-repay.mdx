...
Activating additional vaults appends them to the same lending position automatically. Each vault must belong to your wallet, and the position's total must remain under the caps listed in [Protocol parameters](../testnet-info/protocol-parameters.mdx).
...
* The amount exceeds the Hub's draw cap for that asset. See [Protocol parameters](../testnet-info/protocol-parameters.mdx) for current values.
...
Rate-model anchors per asset live on [Protocol parameters](../testnet-info/protocol-parameters.mdx).

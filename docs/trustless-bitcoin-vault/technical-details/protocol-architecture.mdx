...
![TBV architecture: BTCVault outputs on Bitcoin, protocol and Aave v4 contracts on Ethereum, and off-chain protocol actors](/img/trustless-bitcoin-vault/confluence/technical-details/protocol-architecture/10.png)

...
This page lists the live parameter values for the current Trustless Bitcoin Vault (TBV) Testnet release. For deployed contract addresses, see [Contract addresses](./contract-addresses). Parameters are versioned and can change between releases through governance.
...
| Transfer restrictions | Mint and burn only by `AaveAdapter` | vaultBTC is not freely transferable. It exists only as an internal accounting unit; see [Aave v4 integration](../technical-details/aave-v4-integration). |

## Related

* [Contract addresses](./contract-addresses): deployed contracts that read these parameters.
* [Aave v4 integration](../technical-details/aave-v4-integration): how liquidation parameters are used.
* [Glossary](../reference/glossary): term definitions for the parameters above.

...
| Parameter | Value | Description |
| --- | --- | --- |
| `timelockAssert` | 432 BTC blocks (~3 days) | Challenge window: time for any Universal Challenger (or App Keeper) to broadcast a `ChallengeAssert` after the claim is posted. |

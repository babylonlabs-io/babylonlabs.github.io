...
The Babylon Trustless Bitcoin Vaults (TBV) protocol enables Bitcoin holders to
use their BTC as collateral in DeFi applications on Ethereum without bridging
or wrapping their assets.

...
![TBV flow across three layers — Bitcoin Network: BTC locked in a Taproot script with pre-approved spend paths; Verification Layer: transaction graph construction; Ethereum DeFi: vault onboarding, lending market, borrowing USDC/USDT/WBTC, repayment, and a BTC redemption event returning the BTC to the depositor via a ZK proof verified by BABE](/img/trustless-bitcoin-vault/confluence/start-here/what-is-tbv/TBV1-flow.png)

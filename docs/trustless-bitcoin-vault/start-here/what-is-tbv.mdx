...
In DeFi the word "vault" usually means a capital pool: many users deposit into one shared contract and share returns or risks. A BTCVault returns to the original meaning of "vault" — closer to the secure compartment in a bank than to a DeFi capital pool. Each vault is a **segregated**, depositor-owned Bitcoin output. Three properties define it:
...
| **Trustless Bitcoin Vaults** | **Cryptographic proofs** | **Self-custodial** | **Bitcoin (native)** |

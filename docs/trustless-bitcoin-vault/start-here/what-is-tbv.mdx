...
Babylon Trustless Bitcoin Vaults (TBV) enable Bitcoin holders to use their BTC as collateral in DeFi applications on Ethereum without bridging or wrapping their assets.

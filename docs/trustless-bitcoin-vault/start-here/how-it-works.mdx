...
:::note Diagram
*Cross-chain flow diagram placeholder — to be updated with Vlad's pending screenshot.*
:::
...
:::note Diagram
*Peg-in flow diagram placeholder — to be updated with Vlad's pending screenshot.*
:::

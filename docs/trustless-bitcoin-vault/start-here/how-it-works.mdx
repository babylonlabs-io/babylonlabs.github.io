...
![TBV cross-network architecture: Bitcoin vault, Ethereum coordination contract, BABE on Bitcoin, and Bitcoin light client on Ethereum](/img/trustless-bitcoin-vault/confluence/start-here/how-it-works/TBV4-networks.png)

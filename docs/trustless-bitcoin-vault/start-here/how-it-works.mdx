...
off-chain setup. These participants co-sign the vault's transaction graph, the
complete set of pre-signed transactions covering every legitimate spend path.
None of them has custody of the depositor's BTC. Each participant signs their
part.

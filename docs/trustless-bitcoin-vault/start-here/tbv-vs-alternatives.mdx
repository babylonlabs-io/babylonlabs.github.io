...
* **Babylon's BABE construction (2025+)** combines Taproot's pre-signed spending paths, BitVM-style verification, and a succinct SP1 proof of the Ethereum event into a single challenge procedure that Bitcoin can verify using only existing script primitives.

The Bitcoin features TBV depends on, including Taproot, Schnorr signatures, and hash time-locked contracts, have been part of standard Bitcoin consensus for years.

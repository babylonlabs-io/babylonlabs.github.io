...
You can also press **Run** on any query in these pages to open it in a named
full-page explorer pop-up. The query loads through the URL, and the documentation

...
Hover any query and press **Run** to open it in a named pop-up, ready to edit and
execute. Each query opens in its own full-page explorer window. To stay in one
place and work through several, open the
[full Explorer](pathname:///vault-indexer-explorer) — it carries every example
on this site as a preset, with the whole schema documented alongside.

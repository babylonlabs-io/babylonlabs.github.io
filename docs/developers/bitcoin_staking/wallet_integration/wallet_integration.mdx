...
1. **Native wallet support of the Babylon Genesis chain**:
   ...
   * For detailed integration instructions,
     refer to the [Babylon Wallet Integration guide](/developers/bitcoin_staking/wallet_integration/babylon_wallet_integration/).
...
2. **Support of Bitcoin staking**: Participate in Bitcoin staking
   ...
   * For detailed instructions,
     refer to the [Bitcoin Staking Integration guide](/developers/bitcoin_staking/wallet_integration/bitcoin_wallet_integration/).

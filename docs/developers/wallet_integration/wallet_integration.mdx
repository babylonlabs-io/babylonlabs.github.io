...
and utilizes most of the vanilla Cosmos SDK functionality
...
This document will walk through the considerations of integrating
...
* RPC nodes can be found [here](/developers/babylon_genesis_chain)
* Chain ID: `bbn-test-5`
...
The Babylon PoS chain utilizes the default Cosmos SDK
...
The Babylon blockchain uses an epochized staking

...
Create a new instance of the contract using `tx wasm instantiate` command:
```bash
...
As a result you should see the following output with data store and finalized status and btc_timestamp information:

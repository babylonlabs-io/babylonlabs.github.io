...
| State Snapshot | [Babylon Github](https://github.com/babylonlabs-io/networks/blob/main/bbn-test-5/network-artifacts/bbn-test-5.tar.gz) [NodeStake](https://nodestake.org/babylon) |
| Seed Nodes | [Babylon Github](https://github.com/babylonlabs-io/networks/tree/main/bbn-test-5/network-artifacts/seeds.txt) |
| Peers | [Babylon Github](https://github.com/babylonlabs-io/networks/tree/main/bbn-test-5/network-artifacts/peers.txt) |

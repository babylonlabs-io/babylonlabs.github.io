...
For a complete list of available faucets including rate limits and usage instructions, see the [BABY Faucets documentation](/developers/babylon_genesis_chain/baby_faucets).

Quick options:
- [Xangle Testnet Faucet](https://babylon-explorer.xangle.io/testnet/faucet)
- [HoodScan Faucet](https://babylon-testnet.hoodscan.io/faucet)
- [IT Rocket Faucet](https://testnet.itrocket.net/babylon/faucet)

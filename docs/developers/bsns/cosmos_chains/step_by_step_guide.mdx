...
Please note that the corresponding version tag of the Babylon SDK is [https://github.com/babylonlabs-io/babylon-sdk/tree/v0.5.0-rc.1](https://github.com/babylonlabs-io/babylon-sdk/tree/v0.5.0-rc.1).
...
Starting with this version v0.5.0, the BSN system is registered automatically during IBC channel establishment. That’s what the `BSN_name` and `BSN_description` parameters of the Babylon Contract instantiation message are for.

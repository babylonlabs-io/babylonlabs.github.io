...
## Development on Babylon Genesis

Babylon Genesis is a Cosmos SDK-based blockchain. Development is available on both testnet (permissionless) and mainnet (initially permissioned, transitioning to open access).

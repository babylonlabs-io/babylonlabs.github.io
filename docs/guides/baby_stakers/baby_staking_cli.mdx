...
# [External] BABY Staking CLI Guide
...
<CodeBlock language="bash">babylond keys list</CodeBlock>

### Check Node Connection
<CodeBlock language="bash">babylond status --node https://babylon-testnet-rpc.nodes.guru</CodeBlock>
...
<CodeBlock language="bash">babylond tx epoching delegate [validator-addr] [amount] --from [wallet-name] --chain-id [chain-id] --node [node-url] --gas auto --gas-adjustment 1.2 --fees [fee-amount] -y</CodeBlock>
...
<CodeBlock language="bash">babylond tx epoching delegate bbnvaloper1fa0c7df8v25mv926wey4m9kunhhm7svnp6tezt 1000000ubbn --from test-staking --chain-id bbn-test-5 --node https://babylon-testnet-rpc.nodes.guru --gas auto --gas-adjustment 1.2 --fees 1000ubbn -y</CodeBlock>

## Step 3: Unbond Tokens
### Unbonding Command Format
<CodeBlock language="bash">babylond tx epoching unbond [validator-addr] [amount] --from [wallet-name] --chain-id [chain-id] --node [node-url] --gas auto --gas-adjustment 1.2 --fees [fee-amount] -y</CodeBlock>
...
<CodeBlock language="bash">babylond tx epoching unbond bbnvaloper1fa0c7df8v25mv926wey4m9kunhhm7svnp6tezt 1000000ubbn --from test-staking --chain-id bbn-test-5 --node https://babylon-testnet-rpc.nodes.guru --gas auto --gas-adjustment 1.2 --fees 1000ubbn -y</CodeBlock>

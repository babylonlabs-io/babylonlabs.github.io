...
<ThemedImage
  alt="BABY Staking via Mintscan Step 10"
  sources={{
    light: useBaseUrl('/img/guides/baby_stakers/via_mintscan/10.png'),
    dark: useBaseUrl('/img/guides/baby_stakers/via_mintscan/10_dark.png'),
  }}
/>
###  Conclusion
...
[Discord](https://discord.com/invite/babylonglobal) for support!
...
If you prefer not to use GitHub, you can draft a proposal in another format, but Markdown is the standard for distributed collaboration on text files. The [Babylon Proposal Templates](./proposal_templates.mdx) provide structured formats you should follow.  

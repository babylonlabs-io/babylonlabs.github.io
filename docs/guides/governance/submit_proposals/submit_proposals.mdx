...
| 🔧 Change network parameters (introduce new dapps, inflation, deposit amounts, etc.) | Parameter Change | Consider expedited for security concerns |  
| 🔄 Implement chain-wide software upgrade | Software Upgrade | Consider expedited for critical fixes |  

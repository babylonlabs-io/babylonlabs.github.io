...
Once your proposal is prepared, you will need to present it for structured discussion at the Babylon Foundation Governance Forum at forum.babylon.foundation. After a week, you can choose to submit an on-chain proposal via [CLI](./submit_via_cli.mdx) or [Web](./submit_via_web.mdx).  
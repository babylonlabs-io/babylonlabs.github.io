...
Some explorer tools provide a graphic interface for stakeholders to submit governance proposals via web interface. Mintscan and Node Guru both provide these capabilities. This guide shows you how to complete such submissions online.  

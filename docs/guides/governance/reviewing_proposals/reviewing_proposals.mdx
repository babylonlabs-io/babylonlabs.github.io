...
| Aspect | Description |
|--------|-------------|
| **Type** | Determine if this proposal is a Text, Parameter Change, Community Spend, or a Software Upgrade |
...
- Babylon Genesis Chain Explorer - For checking proposal status and voting history  
  ...
  - [MinScan Explorer - Proposals](https://www.mintscan.io/cosmos/proposals)  

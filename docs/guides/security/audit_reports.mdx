...
<CardSection id="Babylon Security Audit Reports">
  ...
  <Card
    ...
    description="Coinspect Source Code Audit - Phase 2"
  />
  <Card
    title="Zellic Phase 2 Audit Report"
    to="https://docs.babylonlabs.io/assets/files/zellic_source_code_audit_babylon_phase_2_v260324.pdf"
    description="Zellic Source Code Audit - Phase 2"
  />
</CardSection>

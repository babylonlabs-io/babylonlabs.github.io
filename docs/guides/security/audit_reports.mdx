...
V4 upgrade audits for the Babylon Genesis v4 Upgrade are conducted by [Coinspect](https://www.coinspect.com/).
...
An addtional audit for the Babylon Genesis is conducted by [Halborn](https://www.halborn.com/).

<CardSection id="Babylon Genesis Security Audit Reports">
  <BrowserOnly>
    {() => (
      <Card

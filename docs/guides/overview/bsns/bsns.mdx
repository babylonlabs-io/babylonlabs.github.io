...
sidebar_position: 1
keywords:
  - Bitcoin Supercharged Networks integration
  - Shared security for consumer chains
  - Finality provider marketplace
  - CosmWasm contracts for BSN
  - IBC channel setup for BSN
  - Reorg resilience with Bitcoin
  - Checkpoint verification for BSN
  - Zone concierge metadata
---
...
<Link to="/guides/overview/bsns/cosmos_chains">
  Cosmos Chain Integration Guide
</Link>

<Link to="/guides/overview/bsns/op_stack_chains">

...
Initial audits for the Babylon Genesis Chain are conducted by [Coinspect](https://www.coinspect.com/), [Zellic](https://zellic.io/) and [Sherlock](https://sherlock.xyz/).
...
<CardSection id="Babylon Security Audit Reports">
  ...
  <BrowserOnly>
    {() => (
      <Card
        title="Halborn Babylon Genesis Offchain Programs Audit Report"
        to={new URL('/assets/files/Babylon-Genesis_SSC_code_audit_2026_01.pdf', window.location.origin).href}
        description="Halborn Babylon Genesis Offchain Programs Audit Report (Jan 2026)"
        target="_blank"
        rel="noopener noreferrer"
      />
    )}

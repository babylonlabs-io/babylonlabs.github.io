...
keywords:
  ...
  - Native Bitcoin staking architecture
  - Babylon Genesis features
  - Bitcoin light client guide
  - Bitcoin checkpointing guide
  - Epoching module guide
  - Incentive and rewards module
  - Governance parameters guide
---
...
Read more on how to integrate BSNs with Babylon [here](/guides/overview/bsns).
...
* [Babylon SDK (Cosmos SDK reference smart contracts)](/guides/overview/bsns/cosmos_chains/babylon_sdk)

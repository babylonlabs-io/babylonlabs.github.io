...
- [Submit on-chain proposal via CLI](/guides/overview/babylon_genesis/governance/submit_via_cli/)
- [Submit on-chain proposal via Web](/guides/overview/babylon_genesis/governance/submit_via_web/)

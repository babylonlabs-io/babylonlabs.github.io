...
[Babylond](https://github.com/babylonlabs-io/babylon) (install instructions [here](https://github.com/babylonlabs-io/networks/blob/main/bbn-test-6/babylon-node/README.md)) provides various commands that assist you to draft and submit your on-chain proposal. This guide will walk through step by step how to create a proposal.
...
--chain-id=bbn-test-6: Specifies the blockchain network to which you are submitting.
...
While checking for votes, don't forget to rally support from stakers and validators they are most influential in voting. Once vote is finalised, you will see the status change if you query for proposals again.

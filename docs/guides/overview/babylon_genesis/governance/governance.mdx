...
2. **Submission**
   - On-chain proposal submission with initial deposit (via babylond command-line tools or help of an explorer tool such as MintScan)
...
- [Reviewing Proposals](./reviewing_proposals_overview.mdx)
- [Drafting Proposals](./drafting_proposals_overview.mdx)
- [Submit Proposals](./submit_proposals_overview.mdx)

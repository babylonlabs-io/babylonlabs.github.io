...
*More on the staking mechanism can be found [here](/stakers/baby_stakers/staking_mechanism).*
...
*More on the slashing conditions can be found [here](/stakers/baby_stakers/staking_mechanism).*
...
*More on fast unbonding process [here](/stakers/baby_stakers/staking_mechanism).*
...
This dual-staking model is the foundation of Babylon’s Bitcoin Supercharged

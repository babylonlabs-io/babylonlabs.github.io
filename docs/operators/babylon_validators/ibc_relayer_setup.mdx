...
To acquire testnet tokens for Celestia Mocha, please refer to the [Celestia Mocha testnet guide](https://docs.celestia.org/nodes/testnet/mocha/).
To get testnet tokens for Babylon testnet, please refer to the [Babylon testnet guide](https://docs.babylonlabs.io/nodes/testnet/babylon/).
...
[chains.event_source]
mode = "push"
url = "http://babylon-testnet-grpc.polkachu.com:20690" #SUBSTITUE WITH CORRECT URL
batch_delay = "500ms"

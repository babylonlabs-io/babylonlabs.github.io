...
### Node Management
- [`babylond start`](./start.md) - Start the blockchain node
- [`babylond init`](./init.md) - Initialize node configuration
- [`babylond status`](./status.md) - Check node status

### Genesis & Validation
- [`babylond validate-genesis`](./validate-genesis.md) - Validate genesis file
- [`babylond add-genesis-account`](./add-genesis-account.md) - Add genesis accounts

### CometBFT
- [`babylond comet`](./comet.md) - CometBFT consensus commands

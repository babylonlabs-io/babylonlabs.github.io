...
keywords:
  ...
  - Finality provider setup guide
  - babylond CLI commands
  - Node monitoring and key management
  - Slashing and commission parameters
  - Min gas prices and pruning
  - Network upgrade procedure
  - Snapshot and archive node setup
---
...
* I want to run a Finality Provider node to receive BTC delegation and earn staking rewards commission.
...
Finality Provider nodes are specialized nodes that participate in finalization by:
- Committing public randomness for blocks
- Signing blocks using EOTS (Extractable One-Time Signatures)
- Submitting finality signatures
- Securing the network through BTC staking
- Earning commission from delegated stakes
...
committing public randomness and signing blocks.
:::
...
* [Babylon Genesis Mainnet](/guides/overview/babylon_genesis/networks/mainnet)
* [Babylon Genesis Testnet](/guides/overview/babylon_genesis/networks/testnet)
...
:::note
For testnet users, please use the [`v1.0.0-rc.3`](https://github.com/babylonlabs-io/babylon/releases/tag/v1.0.0-rc.3) tag for babylon binary.
:::

...
description: "A Babylon gRPC Gateway is a REST interface for Babylon's gRPC.  This specification documents the RPCs for CometBFT functions."
...
A Babylon gRPC Gateway is a REST interface for Babylon's gRPC.  This specification documents the RPCs for CometBFT functions.

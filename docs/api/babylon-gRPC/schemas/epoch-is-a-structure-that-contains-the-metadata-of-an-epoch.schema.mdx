---
id: epoch-is-a-structure-that-contains-the-metadata-of-an-epoch
title: "Epoch is a structure that contains the metadata of an epoch"
description: ""
sidebar_label: "Epoch is a structure that contains the metadata of an epoch"
hide_title: true
hide_table_of_contents: true
schema: true
sample: {"current_epoch_interval":"string","epoch_number":"string","first_block_height":"string","last_block_time":"2024-07-29T15:51:28.071Z","sealer_app_hash":"string","sealer_block_hash":"string"}
...
<Heading
  ...
  children={"Epoch is a structure that contains the metadata of an epoch"}
>
</Heading>

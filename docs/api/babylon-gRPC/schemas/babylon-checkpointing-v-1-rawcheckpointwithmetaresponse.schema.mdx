---
id: babylon-checkpointing-v-1-rawcheckpointwithmetaresponse
title: "babylon.checkpointing.v1.RawCheckpointWithMetaResponse"
description: "RawCheckpointWithMetaResponse wraps the raw checkpoint with metadata."
sidebar_label: "babylon.checkpointing.v1.RawCheckpointWithMetaResponse"
hide_title: true
hide_table_of_contents: true
schema: true
sample: {"bls_aggr_pk":"string","ckpt":{"bitmap":"string","block_hash_hex":"string","bls_multi_sig":"string","epoch_num":"string"},"lifecycle":[{"block_height":"string","block_time":"2024-07-29T15:51:28.071Z","state":"CKPT_STATUS_ACCUMULATING","status_desc":"string"}],"power_sum":"string","status":"CKPT_STATUS_ACCUMULATING","status_desc":"string"}
...
<Heading
  ...
  children={"babylon.checkpointing.v1.RawCheckpointWithMetaResponse"}
>
</Heading>

...
function ProductCard({
  ...
  return (
    <motion.li variants={variants} transition={transition}>
      <Link
        to={product.link}
        className={`group flex h-full flex-col gap-4 border border-border bg-background p-6 text-foreground transition-colors duration-300 hover:border-accent hover:no-underline ${CUT}`}
      >

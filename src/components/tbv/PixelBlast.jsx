/*
 * PixelBlast — from the free React Bits library.
 *   Source:  https://github.com/DavidHDev/react-bits
 *   Licence: MIT + Commons Clause (c) David Haz
 *
 * The Commons Clause forbids selling or redistributing the components
 * themselves; using them inside a website is expressly permitted, which is
 * what this is. This file is kept close to upstream so the provenance stays
 * obvious — configuration happens at the call site, not by editing here.
 *
 * Component inspired by github.com/zavalit/bayer-dithering-webgl-demo
 *
 * Note for licence scanners: GitHub reports this licence as NOASSERTION
 * because it is a modified MIT, not because it is unlicensed.
 */
